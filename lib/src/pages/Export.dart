...
import 'package:client_chankuap/src/app_bars/export_app_bar.dart';
...
class _ExportState extends State<Export> {
  ...
  late String fecha_una;
  late String fecha_dos;
  late int tipo; // 1 -> entrada, 2 -> salida
                                ...
                                children: [
                                  Expanded(
                                    ...
                                    child: FormBuilderDateRangePicker(
                                        ...
                                        onSaved: (una) => {
                                          fecha_una = una!.start.toString().substring(0, 10),
                                          fecha_dos = una.end.toString().substring(0, 10)
                                        },
                                        format: DateFormat('yy-MM-dd'),
                                        firstDate: DateTime(2021, 1, 1),
                                        lastDate:  DateTime(2060, 1, 01), name: 'date1',
                                    ),
                                  ),
                                ],
                              )
...
//    If all data are correct then save data to out variables
      ...
      try {
        ...
        print(requestUrl);
        var uriResponse = await client.get(Uri.parse(requestUrl));
